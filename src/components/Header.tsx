...
const Header: React.FC<Props> = ({children,className}) => {
    ...
    return (
        <div className={twMerge(`h-fit bg-gradient-to-b from-emerald-800 p-6`,className)}> {/*using the twMerge merges the stylings passed in with classname with the predefined stylings*/}
